...
export const ui = {
  ...
  pt: {
    ...
    'hero.tagline': '.NET & React · Feito para Escalar',
    'hero.tagline2': 'Arquiteto de Microsserviços no Azure',
    'hero.tagline3': 'Integrações de IA que Parecem Naturais',
    'hero.subtagline': '.NET · React · TypeScript · Azure · Microsserviços',
    'hero.cta.downloadCv': 'Baixar CV',
